...
function init() {
  ...
  var tabContent = document.querySelectorAll('.tab_content > *'); // let moreButtons = document.querySelectorAll('.more');

  var modalTriggers = document.querySelectorAll('[data-modal]');
  var closeModalButton = document.querySelectorAll('.close_modal');
  var fileInputs = document.querySelectorAll('input[type="file"]');
  var activeModalElem = null;

  if (fileInputs.length) {
    var getFileNameWithExt = function getFileNameWithExt(event) {
    ...
    Array.from(fileInputs).map(function (elem, index) {
  ...
  if (closeModalButton.length) {
    Array.from(closeModalButton).map(function (elem, index) {
  ...
  if (modalTriggers.length) {
    ...
    Array.from(modalTriggers).map(function (elem, index) {
  ...
  if (tabNavs.length && tabContent.length) {
    ...
    if (window.location.href.includes('#')) {
      ...
      var matchId = function matchId(elem, i) {
        if (elem.id == tabId) {
          return i;
        }
